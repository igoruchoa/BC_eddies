...
C = Basemap(llcrnrlon=lnmn,llcrnrlat=-29,urcrnrlat=ltmx,urcrnrlon=lnmx+0.2,resolution='h',projection='cyl')
...
plt.contourf(xb,yb,zb,levels=[-200,np.inf],alpha=0.8,colors='dimgray')
...
p=plt.figure(figsize=(8.06,  6.19))
lbs=[True, False,False,True]
C = Basemap(llcrnrlon=lnmn+1,llcrnrlat=-32,urcrnrlat=ltmx,urcrnrlon=lnmx,resolution='h',projection='cyl')
...
C = Basemap(llcrnrlon=lnmn+1,llcrnrlat=-32,urcrnrlat=ltmx-1,urcrnrlon=lnmx,resolution='h',projection='cyl')
