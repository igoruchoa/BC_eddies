...
iii=0
for iy in np.unique(achunck):
    print('Loading {0:.2f} % '.format((((iii)/np.unique(achunck).shape[0])*100)),end='\r')
    abol.append(pseg.contains_point((alon[atrack==iy][0],alat[atrack==iy][0])))
    iii+=1
abol=np.array(abol)
iii=0
for iy in np.unique(cchunck):
    print('Loading {0:.2f} % '.format((((iii)/np.unique(cchunck).shape[0])*100)),end='\r')
    cbol.append(pseg.contains_point((clon[ctrack==iy][0],clat[ctrack==iy][0])))
    iii+=1
cbol=np.array(cbol)

auni=np.unique(achunck)[abol]
cuni=np.unique(cchunck)[cbol]
...
for ix in np.unique(atrack):
    try:
        ...
        ag.append((alon[atrack==ix][0]>=-32)|(alat[atrack==ix][0]<=-29)|(alat[atrack==ix][0]>=-14))
...
for ix in np.unique(ctrack):
    try:
        ...
        cg.append((clon[ctrack==ix][0]>=-32)|(clat[ctrack==ix][0]<=-29)|(clat[ctrack==ix][0]>=-14))
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi/figures/dissipation_points.png')
plt.close()
...
for i in range(4):
    ...
    plt.savefig('/home/igor/Documents/AntSimi/figures/Total_formation_season_{0}_modo1.png'.format(mosea[i]))
    ...
    plt.savefig('/home/igor/Documents/AntSimi/figures/Cyclonic_birth_season_{0}_modo1.png'.format(mosea[i]))
    ...
    plt.savefig('/home/igor/Documents/AntSimi/figures/Anticyclonic_birth_season_{0}_modo1.png'.format(mosea[i]))
    plt.close()
...
plt.savefig('/home/igor/Documents/AntSimi/figures/Total_formation_modo2.png')
...
C.contourf(xxb,yyb,zb,colors='dimgray',alpha=1,levels=[-100,np.inf],latlon=True)
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi/figures/Total_dissipation_modo2.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi/figures/Profile_Total_velocity.png')
plt.close()
...
plt.savefig('/home/igor/Documents/AntSimi/figures/SCattermap_Total_velocity.png')
plt.close()
...
plt.savefig('/home/igor/Documents/AntSimi/figures/Total_velocity.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi/figures/Profile_Total_radii.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi/figures/SCattermap_Total_radius.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi/figures/Profile_Total_amplitude.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi/figures/SCattermap_Total_amplitude.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi/figures/SCattermap_Total_nonlinear.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi/figures/SCattermap_Total_duration.png')
plt.close()
