...
p=plt.figure(figsize=(11.06,  8.19))
lbs=[True, False,False,True]
C = Basemap(llcrnrlon=lnmn+1,llcrnrlat=-29,urcrnrlat=ltmx,urcrnrlon=lnmx-2,resolution='h',projection='cyl')
...
for ira in range(atrack.max()):
        ...
        if (arr>=40) & (app>=vamp):
            ...
            adummy[yind,xind]+=1
            nlmap[yind,xind]+=(np.nanmax(anc['speed_average'][:][atrack==ira])/(Apvel[ira]))


for i+55 85 8788-4157 changed to +55 85 9722-3897
TODAY
TODAY
Faz o seguinte
14:23
Vai mudando as imagens
14:24
Eu vou mudar o texto e acp pra vsp
14:24
E ccf pra Vcf, não esquece
14:24
Sim sim
14:24
Ia falar isso agora
...
0:07
14:25
Ei, tenho que te falar um negocio.
14:25
Mas tu tem que ficar calmo e não pode contar pra ngm kk
14:25
Diga
14:26
Ja to nervoso
14:26
Mas nao vou falar pra ninguem
14:26
Kkkk
14:26
Vc vai sair ?
14:26
Se vc sair eu saio tbm
14:26
Nao vou ficar sozinho nessa merda nao kkk
14:26
Dendê 😒
14:27
Não me faz querer desistir disso kkkk
14:27
Kkkk
14:27
Desculpa
...
14:27
14:27
É isso, tava pensando em pedir
14:27
O aviso prévio
14:27
Não to conseguindo fazer nada, fico nervoso toda hora
14:28
Sim sim man
14:28
Eu super te entendo
14:28
mas não queria que tu saisse kkk
14:28
Ta doido ?
14:28
Só drama
...
ah kkkk
14:28
Preciso desse emprego até o final do ano
14:28
entendi
14:28
Que bom.
14:28
Acho que vai ser bom pra sua paz de espírito
14:29
Eu tbm tava muito mal
14:29
Esse cara fode a cabeça de qualquer um
14:29
Tbm nao pode falar pra ninguem ta ?
14:29
Mas o DD
14:30
Ja desisti já
...
kkkkk
14:30
Estude pro seu doc manrc in range(ctrack.max()):
     +55 85 8788-4157 changed to +55 85 9722-3897
TODAY
TODAY
Faz o seguinte
14:23
...
kkkkk
14:30
Estude pro seu doc man   crr=np.mean(cnc['effective_radius'][:].data[ctrack==irc])/1e3
     +55 85 8788-4157 changed to +55 85 9722-3897
TODAY
TODAY
Faz o seguinte
...
kkkkk
14:30
Estude pro seu doc man   cpp=np.mean(cnc['amplitude'][:].data[ctrack==irc])*100
+55 85 8788-4157 changed to +55 85 9722-3897
TODAY
TODAY
Faz o seguinte
...
kkkkk
14:30
Estude pro seu doc man   if (crr>=40) & (cpp>=vamp):
+55 85 8788-4157 changed to +55 85 9722-3897
TODAY
TODAY
Faz o seguinte
...
kkkkk
14:30
Estude pro seu doc man       clx,cly=np.mean(clon[ctrack==irc]),np.mean(clat[ctrack==irc])
     +55 85 8788-4157 changed to +55 85 9722-3897
TODAY
TODAY
Faz o seguinte
...
kkkkk
14:30
Estude pro seu doc man       xind=np.argwhere(clx>=lonf[0,:]).T[0][-1]
     +55 85 8788-4157 changed to +55 85 9722-3897
TODAY
TODAY
Faz o seguinte
...
kkkkk
14:30
Estude pro seu doc man       yind=np.argwhere(cly>=latf[:,0]).T[0][-1]

            cdummy[yind,xind]+=1
            nlmap[yind,xind]+=(np.nanmax(cnc['speed_average'][:][ctrack==irc])/(Cpvel[irc]))
