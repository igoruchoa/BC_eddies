...
c=plt.contourf(xb,yb,zb,levels=[-5000,-200],colors='k')
...
for i in range(4):
    ...
    plt.pcolormesh(lonf,latf,((acmap+ ccmap)/(anumber + cnumber))*100,cmap=cm.cm.tempo,vmin=0,vmax=0.1);
    ...
    plt.savefig('/home/igor/Documents/AntSimi/figures/Total_formation_season_{0}_modo2.png'.format(mosea[i]))
    ...
    # C.contourf(lonf,latf,((acmap+ ccmap)/np.nanmax(acmap + ccmap))*100,cmap='YlGnBu_r',latlon=True,levels=np.linspace(0,60,35))
    # plt.pcolormesh(lonf,latf,((acmap+ ccmap)/np.nanmax(acmap + ccmap))*100,cmap=cm.cm.tempo,vmin=0,vmax=80);
    plt.pcolormesh(lonf,latf,((ccmap)/(cnumber))*100,cmap='Blues',vmin=0,vmax=0.1);

    cbar=plt.colorbar()
    cbar.set_label('Cyclonic Formation {0} [%]'.format(mosea[i]),fontweight='bold') 
    ...
    plt.savefig('/home/igor/Documents/AntSimi/figures/Cyclonic_birth_season_{0}_modo2.png'.format(mosea[i]))
    ...
    # C.contourf(lonf,latf,((acmap+ ccmap)/np.nanmax(acmap + ccmap))*100,cmap='YlGnBu_r',latlon=True,levels=np.linspace(0,60,35))
    # plt.pcolormesh(lonf,latf,((acmap+ ccmap)/np.nanmax(acmap + ccmap))*100,cmap=cm.cm.tempo,vmin=0,vmax=80);
    plt.pcolormesh(lonf,latf,((acmap)/(anumber))*100,cmap='Reds',vmin=0,vmax=0.1);

    cbar=plt.colorbar()
    cbar.set_label('Anticyclonic Formation {0} [%]'.format(mosea[i]),fontweight='bold') 
    ...
    plt.savefig('/home/igor/Documents/AntSimi/figures/Anticyclonic_birth_season_{0}_modo2.png'.format(mosea[i]))
...
plt.pcolormesh(lonf,latf,((acdmap+ ccdmap)/(anumber + cnumber))*100,cmap=cm.cm.tempo,vmin=0,vmax=1);
...
plt.pcolormesh(lonf,latf,((ccmap)/cnumber)*100,cmap='Blues',vmin=0,vmax=80);
...
C.contour(xxb,yyb,-zb,colors='k',alpha=1,levels=[0,100],linewidths=0.5,latlon=True)
# C.contourf(lonf,latf,(acmap - ccmap)/np.nanmax(abs(acmap - ccmap))*100,cmap='seismic',latlon=True,levels=np.linspace(-100,100,35))
plt.pcolormesh(lonf,latf,((acmap)/anumber)*100,cmap='Reds',vmin=0,vmax=80);
