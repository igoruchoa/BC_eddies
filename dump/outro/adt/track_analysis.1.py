...
ltmn=-29;ltmx=-9;lnmn=-52;lnmx=-30.
...
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/formation_points.png')
plt.close()
...
for ip in range(slac.shape[0]):
    ...
    plt.contourf(lonc,latc,slac[ip]-np.nanmean(slac[ip]),cmap='seismic',levels=np.linspace(-0.5,0.5,100))
    ...
    plt.tight_layout()
    plt.savefig('/home/igor/Documents/AntSimi_adt/maps/{0:04d}_track.png'.format(ip+1))
    plt.close()
'''
...
savep='/home/igor/Documents/AntSimi_adt/figures/'
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/Scatter_Cyclone.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/Scatter_AntiCyclone.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/Total_histogram.png')
plt.close()
...
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/Boxplot_Month.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/Total_frequency_anual.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/Total_formation.png')
plt.close()
...
C.contourf(xxb,yyb,zb,colors='dimgray',alpha=1,levels=[-100,np.inf],latlon=True)
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/Total_dissipation.png')
plt.close()
...
C.contourf(xxb,yyb,zb,colors='dimgray',alpha=1,levels=[-100,np.inf],latlon=True)
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/Total_polarity_birth.png')
plt.close()
...
C.contour(xxb,yyb,-zb,colors='k',alpha=1,levels=[0,100],linewidths=0.5,latlon=True)
# C.contourf(lonf,latf,(acmap - ccmap)/np.nanmax(abs(acmap - ccmap))*100,cmap='seismic',latlon=True,levels=np.linspace(-100,100,35))
plt.pcolormesh(lonf,latf,((ccmap)/np.nanmax(ccmap))*100,cmap='Blues',vmin=0,vmax=50);
...
C.contourf(xxb,yyb,zb,colors='dimgray',alpha=1,levels=[-100,np.inf],latlon=True)
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/cyclonic_birth.png')
plt.close()
...
C.contour(xxb,yyb,-zb,colors='k',alpha=1,levels=[0,100],linewidths=0.5,latlon=True)
# C.contourf(lonf,latf,(acmap - ccmap)/np.nanmax(abs(acmap - ccmap))*100,cmap='seismic',latlon=True,levels=np.linspace(-100,100,35))
plt.pcolormesh(lonf,latf,((acmap)/np.nanmax(acmap))*100,cmap='Reds',vmin=0,vmax=50);
...
C.contourf(xxb,yyb,zb,colors='dimgray',alpha=1,levels=[-100,np.inf],latlon=True)
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/anticyclonic_birth.png')
plt.close()
...
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/Total_radius.png')
plt.close()
...
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/Total_amplitude.png')
plt.close()
...
C.contourf(xxb,yyb,zb,colors='dimgray',alpha=1,levels=[-100,np.inf],latlon=True)
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi_adt/figures/Total_nonlinear.png')
plt.close()
