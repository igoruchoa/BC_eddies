...
# iii=0
# for iy in ics:
#     print('{0}%'.format((iii/len(ics))*100),end='\r')
#     ctrack1=np.where(ctrack1==iy,-1,ctrack1)
#     iii+=1
...
# iii=0
# for iy in ias:
#     print('{0}%'.format((iii/len(ias))*100),end='\r')
#     atrack1=np.where(atrack1==iy,-1,atrack1)
#     iii+=1
...
# ctrack2=ctrack1.copy()
# iii=0
# for iy in ics:
#     print('{0}%'.format((iii/len(ics))*100),end='\r')
#     ctrack2=np.where(ctrack2==iy,-1,ctrack2)
#     iii+=1
...
# atrack2=atrack1.copy()
# iii=0
# for iy in ias:
#     print('{0}%'.format((iii/len(ias))*100),end='\r')
#     atrack2=np.where(atrack2==iy,-1,atrack2)
#     iii+=1
...
# ctrack3=ctrack2.copy()
# iii=0
# for iy in ics:
#     print('{0}%'.format((iii/len(ics))*100),end='\r')
#     ctrack3=np.where(ctrack3==iy,-1,ctrack3)
#     iii+=1
...
# atrack3=atrack2.copy()
# iii=0
# for iy in ias:
#     print('{0}%'.format((iii/len(ias))*100),end='\r')
#     atrack3=np.where(atrack3==iy,-1,atrack3)
#     iii+=1
