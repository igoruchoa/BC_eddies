...
'Excluding NH++'
condc=(clon>lnmn-10)&(clon<lnmx+10)&(clat>ltmn-10)&(clat<ltmx+10)
...
# iii=0
# for iyd in  np.unique(achunck):
#     print('Loading Anticyclones {0:.2f} % '.format((((iii)/np.unique(achunck).shape[0])*100)),end='\r')
#     adel.append(ddseg.contains_point((alon[atrack==iyd][0],alat[atrack==iyd][0])))
#     iii+=1
# adel=np.array(adel)

# iii=0
# for iyd in  np.unique(cchunck):
#     print('Loading Cyclones {0:.2f} % '.format((((iii)/np.unique(cchunck).shape[0])*100)),end='\r')
#     cdel.append(ddseg.contains_point((clon[ctrack==iyd][0],clat[ctrack==iyd][0])))
#     iii+=1
# cdel=np.array(cdel)

# pd.Series.to_pickle(adel,'/home/igor/Documents/META_eddy_detection/anticyclone_code.pkl')
# pd.Series.to_pickle(cdel,'/home/igor/Documents/META_eddy_detection/cyclone_code.pkl')

# adel=pd.read_pickle('/home/igor/Documents/META_eddy_detection/anticyclone_code.pkl')
# cdel=pd.read_pickle('/home/igor/Documents/META_eddy_detection/cyclone_code.pkl')

# aduni=np.unique(achunck)[~adel]
# cduni=np.unique(cchunck)[~cdel]


# iii=0
# # atrack=np.float_(atrack);
# for iad in range(len(aduni)):
#     print('Loading Anticyclones {0:.2f} % '.format((((iii)/len(aduni))*100)),end='\r')
#     atrack[atrack==aduni[iad]]=-1
#     iii+=1
# # atrack=np.int_(atrack);
# iii=0
# # ctrack=np.float_(ctrack);
# for icd in range(len(cduni)):
#     print('Loading Cyclones {0:.2f} % '.format((((iii)/len(cduni))*100)),end='\r')
#     ctrack[ctrack==cduni[icd]]=-1
#     iii+=1
# # ctrack=np.int_(ctrack);


# pd.Series.to_pickle(atrack,'/home/igor/Documents/META_eddy_detection/atrack_final.pkl')
# pd.Series.to_pickle(ctrack,'/home/igor/Documents/META_eddy_detection/ctrack_final.pkl')


atrack=pd.read_pickle('/home/igor/Documents/META_eddy_detection/atrack_final.pkl')
ctrack=pd.read_pickle('/home/igor/Documents/META_eddy_detection/ctrack_final.pkl')
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/formation_points.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/dissipation_points.png')
plt.close()
...
savep='/home/igor/Documents/META_eddy_detection/'
...
plt.savefig('/home/igor/Documents/META_eddy_detection/Scatter_Cyclone.png')
plt.close()
...
plt.savefig('/home/igor/Documents/META_eddy_detection/Scatter_AntiCyclone.png')
plt.close()
...
plt.xticks(np.linspace(-10,10,5),np.int_(np.abs(np.linspace(-10,10,5))))
...
plt.xticks(np.linspace(-100,100,3),np.int_(np.abs(np.linspace(-100,100,3))))
plt.xlim(-150,150)
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/Total_histogram.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/Boxplot_Month.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/Boxplot_Seasonal.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/Total_frequency_anual.png')
plt.close()
...
for i in range(4):
    ...
    plt.savefig('/home/igor/Documents/META_eddy_detection/Total_formation_season_{0}_modo1.png'.format(mosea[i]))
    ...
    plt.savefig('/home/igor/Documents/META_eddy_detection/Cyclonic_birth_season_{0}_modo1.png'.format(mosea[i]))
    ...
    plt.savefig('/home/igor/Documents/META_eddy_detection/Anticyclonic_birth_season_{0}_modo1.png'.format(mosea[i]))
    plt.close()
...
plt.savefig('/home/igor/Documents/META_eddy_detection/Total_formation_modo2.png')
...
C.contourf(xxb,yyb,zb,colors='dimgray',alpha=1,levels=[-100,np.inf],latlon=True)
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/Total_dissipation_modo2.png')
plt.close()
...
C.contourf(xxb,yyb,zb,colors='dimgray',alpha=1,levels=[-100,np.inf],latlon=True)
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/cyclonic_birth.png')
plt.close()
...
C.contourf(xxb,yyb,zb,colors='dimgray',alpha=1,levels=[-100,np.inf],latlon=True)
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/anticyclonic_birth.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/Profile_Total_velocity.png')
plt.close()
...
plt.savefig('/home/igor/Documents/META_eddy_detection/SCattermap_Total_velocity.png')
plt.close()
...
plt.savefig('/home/igor/Documents/META_eddy_detection/Total_velocity.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/Profile_Total_radii.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/SCattermap_Total_radius.png')
plt.close()
...
plt.savefig('/home/igor/Documents/META_eddy_detection/Total_radius.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/Profile_Total_amplitude.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/SCattermap_Total_amplitude.png')
plt.close()
...
plt.savefig('/home/igor/Documents/META_eddy_detection/Total_amplitude.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/AntSimi/figures/Profile_Total_nonlinear.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/SCattermap_Total_nonlinear.png')
plt.close()
...
C.contourf(xxb,yyb,zb,colors='dimgray',alpha=1,levels=[-100,np.inf],latlon=True)
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/Total_nonlinear.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/igor/Documents/META_eddy_detection/SCattermap_Total_duration.png')
plt.close()
